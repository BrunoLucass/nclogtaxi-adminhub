...
const CLIENT_MENU: SidebarItem[] = [
  { path: '/client', label: 'Painel', icon: LayoutDashboard },
  { path: '/client/rides', label: 'Corridas', icon: Route },
  { path: '/client/passengers', label: 'Passageiros', icon: Users },
  { path: '/client/finance', label: 'Financeiro', icon: TrendingUp },
];
...
export function ClientLayout() {
  ...
  const currentItem = CLIENT_MENU.find((item) =>
    item.path === '/client'
